...
function ForgotPasswordAdmin() {
  ...
  const handleStep1Submit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/core.php', {
        action: 'verify_security_answers_admin',
        ...answers,
      });
  ...
  const handleStep2Submit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('/api/core.php', {
        action: resetChoice === 'username' ? 'reset_username_admin_by_answers' : 'reset_password_admin_by_answers',
            ...
            <div className="register-content">
              <div className="register-left">
                <div className="register-header">
                  ...
                  <h1 className="register-title">Admin Forgot Password</h1>
                  <p className="register-subtitle">Reset your admin account credentials securely</p>
                </div>
              </div>
              ...
              <div className="register-right register-right-full">
                ...
                {userInfo && (
                  <div className="selected-questions-review">
                    <h3>Verified Admin Information</h3>
                    <ol>
